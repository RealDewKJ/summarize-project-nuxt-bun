  ...
  <div class="project-status-section">
    ...
    <div class="status-grid">
      ...
      <div class="status-card in-progress">
        ...
        <div class="status-description">โครงการที่อยู่ระหว่างการพัฒนาและทดสอบ</div>
      ...
      <div class="status-card issues">
        ...
        <div class="status-examples no-scroll">
          <div v-for="project in meetingData.projects.issues" :key="project" class="example-item">
            • {{ project }}
          </div>
        </div>
      </div>
...
const { meetingData, totalProjects, inProgressCount, completedCount, issuesCount } = store
</script>
